...
public class AppointmentCheck extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.print(
                "<table border='1px solid black' height='10%' width='70%'><tr><th style='background-color:#2874A6; text-color:red'>Patient Name</th>"
                        + "<th style='background-color:#2874A6'>Email</th> <th style='background-color:#2874A6'>Contact</th>");
        out.print("<th style='background-color:#2874A6'>Age</th> <th style='background-color:#2874A6'>Date</th>"
                + " <th style='background-color:#2874A6'>Specialty</th>");
        ...
        if (id == dbe.getId() || email.equals(dbe.getEmail())) {
            ...
            for (AppointmentBean apps : list) {
                out.print("<tr style='background-color:white'><td>" + apps.getName() + "</td><td>" + apps.getEmail()
                        + "</td>");
